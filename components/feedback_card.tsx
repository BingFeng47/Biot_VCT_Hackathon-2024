...
export function FeedbackCard({ avatar, name, email, comment }: FeedbackCardProps) {
  return (
    <CardSpotlight className="lg:h-56 w-30 px-10 dark:bg-black dark:shadow-accent bg-accent shadow-md shadow-muted-foreground border-0 overflow-hidden">
        <div className="flex flex-row gap-4 relative z-20">
            ...
            <div className="flex flex-col gap-1">
                ...
                <p className="text-xs font-thin text-muted-foreground overflow-hidden truncate max-w-34">
                  {email}
                </p>
            </div>
        </div>
