    ...
    <div className="flex flex-col min-h-screen px-20">
      <div id='playerDetails' className='py-10'>
        ...
        <div className='flex flex-row gap-4'>
          ...
          <div className='w-1/4'>
                <Image src={"/placeholder/placeholder_man.png"} width={400} height={400} alt={player.handle} className='rounded-lg object-cover' onLoadingComplete={() => setIsLoading(false)} />
          </div>
          {/* {player.photo_url ? (
