...
import { BookCheck, ChevronDown, Dice1, FileCheck, Frown, Gamepad2, Skull, Sparkle, Sparkles, Swords, Trophy } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchPlayer = async () => {
      ...
      const { data: playerDetails, error: detailsError } = await supabase
        .from('challengers-player-details')
        .select('*')
      ...
      <div id='playerDetails' className='pt-10 pb-10'>
        ...
        <div className='flex flex-row gap-10'>
          ...
          {player.photo_url ? (
              ...
              <Image src={'http://static.lolesports.com/players/silhouette.png?w=50&h=50&fit=crop'} width={400} height={400} alt={player.handle}  onLoadingComplete={() => setIsLoading(false)} />
            )
          }
